...
# Create a histogram for fuel price distribution for Kolkata
plt.figure(figsize=(10,6))
plt.hist(data['Kolkata'], bins=20, alpha=0.5, label='Kolkata')
plt.title('Fuel Price Distribution for Kolkata')
plt.xlabel('Price (INR/Litre)')
plt.ylabel('Frequency')
plt.legend()
plt.grid(True)
